...
var createError = __webpack_require__(7)
var getBody = __webpack_require__(151)
var iconv = __webpack_require__(59)
var onFinished = __webpack_require__(13)
var zlib = __webpack_require__(43)
...
var destroy = __webpack_require__(119)
...
var statuses = __webpack_require__(122)
...
const getString = __webpack_require__(146);
...
var bomHandling = __webpack_require__(152),
    iconv = module.exports;
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(153); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    var nodeVerArr = nodeVer.split(".").map(Number);
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(167)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(168)(iconv);
}
...
const express = __webpack_require__(65);
const serverless = __webpack_require__(139);
const app = express();
const bodyParser = __webpack_require__(149);
...
var deprecate = __webpack_require__(79)('http-errors')
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(41)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var onFinished = __webpack_require__(13)
var parseUrl = __webpack_require__(14)
var statuses = __webpack_require__(113)
var unpipe = __webpack_require__(25)
...
var codes = __webpack_require__(114)
...
const finish = __webpack_require__(140);
const getHandler = __webpack_require__(141);
const cleanUpEvent = __webpack_require__(142);
const sanitizeHeaders = __webpack_require__(143);
const getBody = __webpack_require__(145);
const isBinary = __webpack_require__(147);
...
const setCookieVariations = __webpack_require__(144).variations;
...
function loadParser (parserName) {
  ...
  switch (parserName) {
    ...
    case 'raw':
      ...
      break
    case 'text':
      parser = __webpack_require__(170)
      break
    case 'urlencoded':
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(162) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
        encodeSkipVals: [{from: 0xED40, to: 0xF940}],
    },
    'csshiftjis': 'shiftjis',
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(163) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(31).concat(__webpack_require__(60)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(31).concat(__webpack_require__(60)) },
        gb18030: function() { return __webpack_require__(164) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(165) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(61).concat(__webpack_require__(166)) },
        encodeSkipVals: [0xa2cc],
    },
